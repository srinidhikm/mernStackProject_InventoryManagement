...
const Totalcustomers = () => {
    ...
    { e.preventDefault();
     ...
     const res = await fetch(`/delcustomer/${delit}`,
      {
        method:'GET'
  ...
  return (
    ...
    <h1 className='text-monospace text-white text-center'><span className='fontfamabout'>C U S T O M E R S</span></h1>  
  ...
  <table className="table table-dark ">
    ...
    { name.map( (val,key) =>
      ...
      <tr>
        ...
        <a className='text-white' href={"/editcustomer/"+val._id} >Edit</a>
